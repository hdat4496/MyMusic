        ...
        datasets: [
          {
            ...
            pointBorderColor: '#FFCA3A',
            pointBackgroundColor: '#fff',
            pointBorderWidth: 1,
            pointHoverRadius: 5,
            pointHoverBackgroundColor: '#FFCA3A',
            pointHoverBorderColor: '#FFCA3A',
        ...
        datasets: [
          {
            ...
            borderDashOffset: 0.0,
            borderJoinStyle: 'miter',
            pointBorderColor: '#8AC926',
            pointBackgroundColor: '#fff',
            pointBorderWidth: 1,
            pointHoverRadius: 5,
            pointHoverBackgroundColor: '#8AC926',
        ...
        datasets: [
          {
            ...
            borderDashOffset: 0.0,
            borderJoinStyle: 'miter',
            pointBorderColor: '#FF331F',
            pointBackgroundColor: '#fff',
            pointBorderWidth: 1,
            pointHoverRadius: 5,
            pointHoverBackgroundColor: '#FF331F',
            pointHoverBorderColor: '#FF331F',
            pointHoverBorderWidth: 2,
            pointRadius: 1,
            pointHitRadius: 10,
